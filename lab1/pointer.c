...
int intSize() {
  ...
  int * intPtr1;
  int * intPtr2;
  // TODO: Write code to compute size of an integer.z
  intPtr1 = intArray;
  intPtr2 = intArray + 1;
...
/*
 * Return 1 if Return 1 if ptr1 and ptr2 are within the *same* 64-byte aligned
...
int withinArray(int * intArray, int size, int * ptr) {
  ...
  int parry = intArray;
  int pptr = ptr;
  return (!!((ptr - intArray - size) >> 31)) & (!((ptr - intArray) >> 31));
}
/*
